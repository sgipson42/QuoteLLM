...
filepath = '/Users/skyler/Desktop/QuoteLLM/results3.0/CSVs/'
file_data = []
...
plt.savefig('/Users/skyler/Desktop/QuoteLLM/results3.0/visualization/levenshtein_heatmaps/categories-2d-histogram.png')
plt.show()
